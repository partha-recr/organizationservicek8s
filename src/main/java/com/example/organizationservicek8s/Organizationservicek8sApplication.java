package com.example.organizationservicek8s;
...
@EnableFeignClients
@EnableSwagger2
public class Organizationservicek8sApplication {

	public static void main(String[] args) {
		SpringApplication.run(Organizationservicek8sApplication.class, args);
	}
	@Bean
